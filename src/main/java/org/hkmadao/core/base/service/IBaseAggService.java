...
public interface IBaseAggService<T extends BaseEntity, ID> {
    ...
    void deleteAllInBatch(List<T> entity) throws BusinessException;

     void deleteAllById(List<ID> ids) throws BusinessException;
     ...
     * @return 记录数据
     */
    List<T> findAllById(List<ID> ids) throws BusinessException;
