package org.hkmadao.tcdt.modules.sysperm.userrole.dao.desc;
...
public class UserRoleDesc extends BaseDesc {
    ...
    protected void setEntityInfo() {
        ...
        entityInfo.setBasePath("org.hkmadao.tcdt.modules.sysperm.userrole");
    }
    ...
    protected void setNormalFkIdAttributeInfos() {
        normalFkIdAttributeInfos.add(idUserDesc());
    ...
    protected void setNormalFkAttributeInfos() {
        normalFkAttributeInfos.add(userDesc());
