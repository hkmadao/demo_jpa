package org.hkmadao.tcdt.modules.sysperm.user.dao.desc;
...
public class UserDesc extends BaseDesc {
    ...
    protected void setEntityInfo() {
        ...
        entityInfo.setBasePath("org.hkmadao.tcdt.modules.sysperm.user");
    }
